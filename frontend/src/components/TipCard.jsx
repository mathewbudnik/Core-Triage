...
const TIPS = [
  {
    category: 'Prevention',
    icon: Shield,
    color: '#f0a875',       // terra-soft
    glow: 'rgba(240,168,117,0.15)',
  ...
  return (
    <div
      style={{
        ...
        background: `linear-gradient(135deg, ${tip.glow} 0%, rgba(28,37,32,0.0) 60%)`,
    ...
    >
      ...
      <div style={{ padding: '10px 12px 10px' }}>
            ...
            {TIPS.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 3,
                  borderRadius: 99,
                  backgroundColor: i === index ? tip.color : 'rgba(230,237,228,0.10)',
        ...
        <button
          ...
          onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(230,237,228,0.30)'}
        >
