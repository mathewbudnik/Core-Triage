...
export default function TriageFingerDetails({
  ...
  return (
    <div className="space-y-3">
      <div>
        <p className="text-xs font-semibold text-ink-soft mb-1.5">Which finger?</p>
        <ChipGroup
          options={fingerChips}
          value={whichFinger}
      ...
      <div>
        <p className="text-xs font-semibold text-ink-soft mb-1">Where on the finger?</p>
      ...
      <div>
        <p className="text-xs font-semibold text-ink-soft mb-1.5">Grip at injury</p>
        <ChipGroup
          options={gripChips}
          value={gripMode}
